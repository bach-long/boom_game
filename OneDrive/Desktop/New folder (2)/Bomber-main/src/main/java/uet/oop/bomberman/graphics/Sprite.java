...
public class Sprite {
    ...
    public static Sprite[][] hp = new Sprite[1][3];
    public static Sprite[][] turtle_up = new Sprite[1][3];
    public static Sprite[][] turtle_down = new Sprite[1][3];
    public static Sprite[][] turtle_left = new Sprite[1][3];
    public static Sprite[][] turtle_right = new Sprite[1][3];
    public static Sprite[][] rage1 = new Sprite[1][1];
    public static Sprite[][] rage2 = new Sprite[1][1];
    public static Sprite[][] Hitup = new Sprite[1][1];
    public static Sprite[][] Hitdown = new Sprite[1][1];
    public static Sprite[][] Hitleft = new Sprite[1][1];
    public static Sprite[][] Hitright = new Sprite[1][1];
    public static Sprite[][] turtle_die = new Sprite[1][1];
    ...
    static {
        ...
        set_moveset(hp, SpriteSheet.all, 3, 1, 42, 45, 450, 900);
        set_moveset(turtle_up, SpriteSheet.all, 3, 1, 125, 150, 900, 150);
        set_moveset(turtle_down, SpriteSheet.all, 3, 1, 131, 115, 900, 0);
        set_moveset(turtle_left, SpriteSheet.all, 3, 1, 197, 120, 300, 150);
        set_moveset(turtle_right, SpriteSheet.all, 3, 1, 199, 120, 300, 0);
        set_moveset(rage1, SpriteSheet.all, 1, 1, 140, 116, 1350, 150);
        set_moveset(rage2, SpriteSheet.all, 1, 1, 129, 117, 1500, 0);
        set_moveset(Hitup, SpriteSheet.all, 1, 1, 169, 149, 1350, 150);
        set_moveset(Hitdown, SpriteSheet.all, 1, 1, 165, 141, 1650, 0);
        set_moveset(Hitleft, SpriteSheet.all, 1, 1, 216, 150, 450, 300);
        set_moveset(Hitright, SpriteSheet.all, 1, 1, 217, 150, 750, 300);
        set_moveset(turtle_die, SpriteSheet.all, 1, 1, 135, 129, 300, 300);
    }
