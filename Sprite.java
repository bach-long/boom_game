...
public class Sprite {
    ...
    public static Sprite[][] move_set = new Sprite[4][6];
    public static Sprite[][] move_set1 = new Sprite[4][6];
    ...
    static {
    set_moveset(move_set, SpriteSheet.all, 6, 4, 45, 60, 0, 0);
    set_moveset(move_set1, SpriteSheet.all, 6, 4, 50, 57, 0, 240);
